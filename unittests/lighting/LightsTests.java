...
public class LightsTests {
   ...
   /** Produce a picture of sphere lighted by three lights */
   @Test
   public void sphereMultiLights() {
      scene1.geometries.add(sphere);
      scene1.lights
              .addAll(List.of(new SpotLight(sphereLightColor, sphereLightPosition, new Vector(1, 1, -0.5))
                      .setNarrowBeam(10).setKl(0.001).setKq(0.00004),
                      new PointLight(new Color(500,300,750), new Point(0,0,25))
                      ));
   ...
   /** Produce a picture of two triangles lighted by three lights */
   @Test
   public void trianglesMultiLights() {
      scene2.geometries.add(triangle1, triangle2);
      scene2.lights
              .addAll(List.of(new SpotLight(new Color(500,500,800), new Point(30,40,-100), new Vector(-2,-10,-2)).setKl(0.005).setKq(0.0005),
              new PointLight(new Color(700,200,200), new Point(80, 40, -130)).setKl(0.001).setKq(0.0001),
              new DirectionalLight(new Color(100,80,0), new Vector(2,5,-2))
      ));
